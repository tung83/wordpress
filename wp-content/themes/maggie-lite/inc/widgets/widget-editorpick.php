 ...
 * @package 8Store Pro
 */
add_action('widgets_init', 'maggie_lite_register_preview_post_widget');

function maggie_lite_register_preview_post_widget() {
	register_widget('maggie_lite_editor_pick');
}

class maggie_lite_editor_pick extends WP_Widget {
    ...
    public function __construct() {
    	parent::__construct(
    		'maggie_lite_editor_pick', 'Maggie : Category Posts', array(
    			'description' => __('A widget that shows posts of a category', 'maggie-lite')
    			)
    		);
    }
    ...
    private function widget_fields() {
    	$fields = array(
    		...
    		'cat_id' => array(
    			...
    			'maggie_lite_widgets_title' => __('Post', 'maggie-lite'),
    						...
    						<div class="post-image">
    							<?php if(has_post_thumbnail()): ?>
                                    <div class="block-poston">
                                        ...
                                        <a class="<?php echo $colors[$choosed_color];?>" href="<?php echo esc_url(get_category_link($editor_cat)); ?>"><?php echo esc_attr(get_cat_name($editor_cat)); ?></a>
                                    </div>
                                    <?php do_action( 'maggie_lite_post_format_icon' ); ?>
    								<a href="<?php the_permalink();?>">
    									<?php the_post_thumbnail('maggie-lite-blockthree-big-thumb');?>
    								</a>
    							<?php endif ;?>
    							<div class="post-desc-wrapper">
    								...
    								<div class="post-content"><?php echo maggie_lite_word_count( get_the_content(), 15);?></div>
    							</div>
    						</div>
    					</div>
    					<?php
