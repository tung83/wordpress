 ...
 * @package Maggie Lite
 */
function maggie_lite_widgets_show_widget_field($instance = '', $widget_field = '', $athm_field_value = '') {
    extract($widget_field);

    switch ($maggie_lite_widgets_field_type) {

        // Standard text field
        case 'text' :
        ?>
        <p>
            <label for="<?php echo $instance->get_field_id($maggie_lite_widgets_name); ?>"><?php echo $maggie_lite_widgets_title; ?>:</label>
            <input class="widefat" id="<?php echo $instance->get_field_id($maggie_lite_widgets_name); ?>" name="<?php echo $instance->get_field_name($maggie_lite_widgets_name); ?>" type="text" value="<?php echo esc_attr($athm_field_value) ; ?>" />

            <?php if (isset($maggie_lite_widgets_description)) { ?>
                <br />
                <small><?php echo $maggie_lite_widgets_description; ?></small>
                <?php } ?>
            </p>
            <?php
            break;
        ...
        // Standard url field
                ...
                <p>
                    <label for="<?php echo $instance->get_field_id($maggie_lite_widgets_name); ?>"><?php echo $maggie_lite_widgets_title; ?>:</label>
                    <input class="widefat" id="<?php echo $instance->get_field_id($maggie_lite_widgets_name); ?>" name="<?php echo $instance->get_field_name($maggie_lite_widgets_name); ?>" type="text" value="<?php echo $athm_field_value; ?>" />
        ...
        // Textarea field
                    ...
                    <p>
                        <label for="<?php echo $instance->get_field_id($maggie_lite_widgets_name); ?>"><?php echo $maggie_lite_widgets_title; ?>:</label>
                        <textarea class="widefat" rows="<?php echo $maggie_lite_widgets_row; ?>" id="<?php echo $instance->get_field_id($maggie_lite_widgets_name); ?>" name="<?php echo $instance->get_field_name($maggie_lite_widgets_name); ?>"><?php echo $athm_field_value; ?></textarea>
                    </p>
                    <?php
                    break;
        ...
        // Checkbox field
                    ...
                    ?>
                    <p>
                        <input id="<?php echo $instance->get_field_id($maggie_lite_widgets_name); ?>" name="<?php echo $instance->get_field_name($maggie_lite_widgets_name); ?>" type="checkbox" value="1" <?php checked('1', $athm_field_value); ?>/>
                        <label for="<?php echo $instance->get_field_id($maggie_lite_widgets_name); ?>"><?php echo $maggie_lite_widgets_title; ?></label>
        ...
        // Radio fields
                    ...
                    <p>
                        <?php
                        echo $maggie_lite_widgets_title;
                        echo '<br />';
                        foreach ($maggie_lite_widgets_field_options as $athm_option_name => $athm_option_title) {
                            ?>
                            <input id="<?php echo $instance->get_field_id($athm_option_name); ?>" name="<?php echo $instance->get_field_name($maggie_lite_widgets_name); ?>" type="radio" value="<?php echo $athm_option_name; ?>" <?php checked($athm_option_name, $athm_field_value); ?> />
        ...
        // Select field
                    ...
                    <p>
                        <label for="<?php echo $instance->get_field_id($maggie_lite_widgets_name); ?>"><?php echo $maggie_lite_widgets_title; ?>:</label>
                        <select name="<?php echo $instance->get_field_name($maggie_lite_widgets_name); ?>" id="<?php echo $instance->get_field_id($maggie_lite_widgets_name); ?>" class="widefat">
                            <?php foreach ($maggie_lite_widgets_field_options as $athm_option_name => $athm_option_title) { ?>
                    ...
                    ?>
                    <p>
                        <label for="<?php echo $instance->get_field_id($maggie_lite_widgets_name); ?>"><?php echo $maggie_lite_widgets_title; ?>:</label><br />
                        <input name="<?php echo $instance->get_field_name($maggie_lite_widgets_name); ?>" type="number" step="1" min="1" id="<?php echo $instance->get_field_id($maggie_lite_widgets_name); ?>" value="<?php echo $athm_field_value; ?>" class="small-text" />
        ...
        // Select field
                    ...
                    <p>
                        <label for="<?php echo $instance->get_field_id($maggie_lite_widgets_name); ?>"><?php echo $maggie_lite_widgets_title; ?>:</label>
                        <select name="<?php echo $instance->get_field_name($maggie_lite_widgets_name); ?>" id="<?php echo $instance->get_field_id($maggie_lite_widgets_name); ?>" class="widefat">
                            <?php foreach ($maggie_lite_postlist as $maggie_lite_single_post) { ?>
                                <option value="<?php echo $maggie_lite_single_post['value']; ?>" id="<?php echo $instance->get_field_id($maggie_lite_single_post['label']); ?>" <?php selected($maggie_lite_single_post['value'], $athm_field_value); ?>><?php echo $maggie_lite_single_post['label']; ?></option>
                                <?php 
                            } ?>
                        </select>
             ...
             // Select field
                    ...
                    <p>
                        ...
                        echo wp_dropdown_categories(
                            array(
                              'name'              => $instance->get_field_name($maggie_lite_widgets_name),
                              'echo'              => 0,
                              'show_option_none'  => __( '&mdash; Select &mdash;','maggie-lite' ),
                              'option_none_value' => '0',
                              'selected'          => $athm_field_value,
                              'id'                => $instance->get_field_id($maggie_lite_widgets_name),
                              'class'             =>'widefat'
                              )
                            );
                        ?>
                    ...
                    <p>
                        ...
                        <input class="hidden-icon-input" name="<?php echo $instance->get_field_name($maggie_lite_widgets_name); ?>" type="hidden" id="<?php echo $instance->get_field_id($maggie_lite_widgets_name); ?>" value="<?php echo $athm_field_value; ?>" />
            ...
            function maggie_lite_widgets_updated_field_value($widget_field, $new_field_value) {

                extract($widget_field);

    // Allow only integers in number fields
                if ($maggie_lite_widgets_field_type == 'number') {
                    return absint($new_field_value);

        // Allow some tags in textareas
                } elseif ($maggie_lite_widgets_field_type == 'textarea') {
        // Check if field array specifed allowed tags
                    if (!isset($maggie_lite_widgets_allowed_tags)) {
            // If not, fallback to default tags
                        $maggie_lite_widgets_allowed_tags = '<p><strong><em><a>';
                    }

                    return strip_tags($new_field_value, $maggie_lite_widgets_allowed_tags);

        // No allowed tags for all other fields
                } 
                elseif ($maggie_lite_widgets_field_type == 'url') {
                    return esc_url_raw($new_field_value);
                }
                elseif ($maggie_lite_widgets_field_type == 'title') {
